...
| Public package build from fresh clone | Gated | `packaging/STRAYLIGHT_PACKAGE_SPLIT.md`, `docs/PACKAGE_PAYLOAD_INVENTORY.md`, roadmap milestone | Complete `v0.2.0-alpha` milestone issues |
