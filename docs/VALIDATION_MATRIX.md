...
| Public package build from fresh clone | Gated | `packaging/STRAYLIGHT_PACKAGE_SPLIT.md`, roadmap milestone | Complete `v0.2.0-alpha` milestone issues |
...
| ISO artifact is publicly verified | Gated | README marks ISO as alpha test media | Build reproducible ISO candidate and pass VM boot/install gates |
