...
| Public package build from fresh clone | Gated | `packaging/STRAYLIGHT_PACKAGE_SPLIT.md`, `docs/PACKAGE_PAYLOAD_INVENTORY.md`, `docs/CLEAN_CLONE_PACKAGE_CHECK.md`, `scripts/check_package_dependencies.sh`, roadmap milestone | Complete `v0.2.0-alpha` milestone issues |
