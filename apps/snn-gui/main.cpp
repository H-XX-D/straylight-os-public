// apps/snn-gui/main.cpp
// StrayLight SNN — Wayland + EGL + ImGui application
#include "snn_panel.h"
...
int main() {
    ...
    xdg_toplevel_set_title(ws.toplevel, "StrayLight SNN");
    xdg_toplevel_set_app_id(ws.toplevel, "straylight.snn-gui");
    ...
    while (g_running.load()) {
        ...
        ImGui::Begin("StrayLight SNN", nullptr,
