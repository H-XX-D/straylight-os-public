// apps/morph-gui/main.cpp
// StrayLight Morph — Wayland + EGL + ImGui application
...
int main() {
    ...
    xdg_toplevel_set_title(ws.toplevel, "StrayLight Morph");
    xdg_toplevel_set_app_id(ws.toplevel, "straylight.morph-gui");
    ...
    straylight::morph::MorphPanel panel;
    panel.init();
    ...
    while (g_running.load()) {
        ...
        ImGui::Begin("StrayLight Morph", nullptr,
