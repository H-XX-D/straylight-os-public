// StrayLight System Updater — Wayland + EGL + ImGui application
...
int main(int, char*[]) {
    ...
    Log::init("straylight-update");
    SL_INFO("StrayLight System Updater starting");
    ...
    xdg_toplevel_set_title(ws.toplevel, "StrayLight System Updater");
    xdg_toplevel_set_app_id(ws.toplevel, "straylight-update");
    ...
    straylight::update::UpdateState app_state;

    SL_INFO("StrayLight System Updater initialized");
    ...
    while (g_running.load(std::memory_order_relaxed)) {
        ...
        if (ImGui::Begin("##Main", nullptr, kWinFlags)) {
            straylight::update::render_update_panel(app_state);
        }
        ImGui::End();
        ImGui::Render();
    ...
    SL_INFO("StrayLight System Updater shutting down");
    ...
    SL_INFO("StrayLight System Updater exited cleanly");
    return EXIT_SUCCESS;
}
