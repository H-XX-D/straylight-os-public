// apps/pmem-gui/main.cpp
// StrayLight PMEM — Wayland + EGL + ImGui application
...
int main() {
    ...
    if (!ws.display) { SL_ERROR("pmem-gui: Cannot connect to Wayland display"); return 1; }
    ...
    xdg_toplevel_set_title(ws.toplevel, "StrayLight PMEM");
    xdg_toplevel_set_app_id(ws.toplevel, "straylight.pmem-gui");
    ...
    straylight::pmem::PmemPanel panel;
    panel.init();
    ...
    while (g_running.load()) {
        ...
        ImGui::Begin("StrayLight PMEM", nullptr,
