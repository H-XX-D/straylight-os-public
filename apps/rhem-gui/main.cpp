// apps/rhem-gui/main.cpp
// StrayLight RHEM — Wayland + EGL + ImGui application
...
int main() {
    ...
    if (!ws.display) { SL_ERROR("rhem-gui: Cannot connect to Wayland display"); return 1; }
    ...
    xdg_toplevel_set_title(ws.toplevel, "StrayLight RHEM");
    xdg_toplevel_set_app_id(ws.toplevel, "straylight.rhem-gui");
    ...
    straylight::rhem::RhemPanel panel;
    panel.init();
    ...
    while (g_running.load()) {
        ...
        ImGui::Begin("StrayLight RHEM", nullptr,
